function [label2, correct, accs2] = getacc45(subject, type, N, numtrain, HDscale, pchan)
    dirname4 = ['./SubjectData/' num2str(subject,'%03.f') '-Session4/']; % directory for session 1 training data
    dirname5 = ['./SubjectData/' num2str(subject,'%03.f') '-Session5/']; % directory for session 2 testing data
